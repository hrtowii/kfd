...
//    NSURL* tccd_orig = [documentDirectory URLByAppendingPathComponent:@"tccd_orig.bin"];
    NSURL* tccd_patched = [documentDirectory URLByAppendingPathComponent:@"tccd_patched_codesigned"];
    // codesign with CT bug to unsandbox.
//    execve([documentDirectory URLByAppendingPathComponent:@"ct_bypass"], <#char *const *argv#>, <#char *const *envp#>)
...
//        xpc_crasher("com.apple.tccd");
        ...
        if (extension_token == nil) {
            ...
            printf("WE DOWN MEDIA LIBRARY INSTEAD!!!!!");
            returnError = [NSError
