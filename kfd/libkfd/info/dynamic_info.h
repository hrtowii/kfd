...
//iPhone 11, 16.4.1
    ...
    // iPhone 14 Pro, 17.0 beta 1
    {   .kern_version = "Darwin Kernel Version 23.0.0: Tue May 23 00:20:52 PDT 2023; root:xnu-10002.0.40.502.3~1/RELEASE_ARM64_T8120",
        .fileglob__fg_ops = 0x28,
        .fileglob__fg_data = 0x40 - 8,
        .fileops__fo_kqfilter = 0x30,
        // .fileproc__fp_iocount = 0x0000,
        ...
        ._vm_map__hdr__rb_head_store__rbh_root = 0x38,
        ._vm_map__pmap = 0x40,
        ._vm_map__hint = 0xa8 + 0x08,
        ._vm_map__hole_hint = 0xa8 + 0x10,
        ._vm_map__holes_list = 0xa8 + 0x18,
        ._vm_map__object_size = 0xd0,
        .kernelcache__kernel_base = 0xfffffff027004000,
        .kernelcache__cdevsw = 0xFFFFFFF02A80D868,
        .kernelcache__gPhysBase = 0xFFFFFFF0279CDBA0,
        .kernelcache__gPhysSize = 0xFFFFFFF0279CDBA0 + 8,
        .kernelcache__gVirtBase = 0xFFFFFFF0279A0C98,
        .kernelcache__vn_kqfilter = 0xFFFFFFF02806B658,
        .kernelcache__perfmon_devices = 0xfffffff02a84f030,
        .kernelcache__perfmon_dev_open = 0xfffffff02801acb0,
//        .kernelcache__ptov_table = 0xfffffff0078ff9b8, // broken?
        .kernelcache__ptov_table = 0xfffffff0278ff9b8, // https://github.com/apple-oss-distributions/xnu/blob/aca3beaa3dfbd42498b42c5e5ce20a938e6554e5/osfmk/arm64/arm_vm_init.c#L379C14-L379C24 on iOS 16, looks like the string doesn't exist on 17 because of SPTM
        .kernelcache__vm_first_phys_ppnum = 0xfffffff02a84e3f0,
        .kernelcache__vm_pages = 0xfffffff0078fc108,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff02797d4a8,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff02a84e3e8,
    },
    // iPhone XR, 17.0 beta 1
    {
        .kern_version = "Darwin Kernel Version 23.0.0: Tue May 23 00:18:15 PDT 2023; root:xnu-10002.0.40.502.3~1/RELEASE_ARM64_T8020",
        .fileglob__fg_ops = 0x28,
        .fileglob__fg_data = 0x40 - 8,
        .fileops__fo_kqfilter = 0x30,
        // .fileproc__fp_iocount = 0x0000,
        ...
        .task__itk_space = 0x300,
        .task__object_size = 0x628,
        .thread__task_threads__next = 0x360 - 0x18,
        .thread__task_threads__prev = 0x360 - 0x18 + 8,
        .thread__map = 0x360,
        .thread__thread_id = 0x400,
...
//        .kernelcache__gVirtBase = %kernelcache__gVirtBase%,
        .kernelcache__perfmon_devices = 0xfffffff00a520e70,
        .kernelcache__perfmon_dev_open = 0xfffffff007f6a124,
//        .kernelcache__ptov_table = %kernelcache__ptov_table%,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a520190,
//        .kernelcache__vm_pages = %kernelcache__vm_pages%,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007955c88,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a520188,
